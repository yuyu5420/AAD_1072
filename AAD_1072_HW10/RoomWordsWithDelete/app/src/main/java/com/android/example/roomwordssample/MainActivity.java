...
public class MainActivity extends AppCompatActivity {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == NEW_WORD_ACTIVITY_REQUEST_CODE && resultCode == RESULT_OK) {
            ...
            String answer = data.getStringExtra(NewWordActivity.EXTRA_ANSWER);
            Word input_data = new Word(word + "+" + answer);
            // Save the data
            mWordViewModel.insert(input_data);
        } else if (requestCode == UPDATE_WORD_ACTIVITY_REQUEST_CODE
                && resultCode == RESULT_OK) {
            String word = data.getStringExtra(NewWordActivity.EXTRA_REPLY);
            String answer = data.getStringExtra(NewWordActivity.EXTRA_ANSWER);
            String origin = data.getStringExtra(NewWordActivity.EXTRA_ORIGIN);
            Word input_data = new Word(word + "+" + answer);
            // Save the data
            mWordViewModel.insert(input_data);
            mWordViewModel.deleteWord(new Word(origin));

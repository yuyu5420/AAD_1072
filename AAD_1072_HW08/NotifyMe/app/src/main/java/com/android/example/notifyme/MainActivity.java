...
public class MainActivity extends AppCompatActivity {
    ...
    public void updateNotification() {
        ...
        NotificationCompat.Builder notifyBuilder = getNotificationBuilder().setContentText("").setContentTitle("Title").setStyle(new NotificationCompat.InboxStyle().addLine("Here is the first one").addLine("This is the second one").addLine("Yay last one").setSummaryText("+1 more"));
        // Deliver the notification.
        mNotifyManager.notify(NOTIFICATION_ID, notifyBuilder.build());
